...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FAetherWorldMapRegistryTest,"AgeOfAether.World.MapRegistry",EAutomationTestFlags_ApplicationContextMask|EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FAetherWorldMapBoundsTest,"AgeOfAether.World.MapValidation",EAutomationTestFlags_ApplicationContextMask|EAutomationTestFlags::ProductFilter)
