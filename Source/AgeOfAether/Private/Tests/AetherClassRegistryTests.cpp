...
bool FAetherClassReferenceTest::RunTest(const FString&){FAetherClassRegistry R;FString E;R.RegisterClass(BaseClass(TEXT("A")),E);auto X=Evo(TEXT("A.1"),TEXT("A"),1);X.VisualAssetIDs.Add(TEXT("asset.missing"));R.RegisterEvolution(X,E);TArray<FAetherClassValidationIssue>I; FAetherAssetRegistry A; TestFalse(TEXT("missing asset detected"),R.Validate(I,nullptr,nullptr,nullptr,nullptr,&A));return true;}
